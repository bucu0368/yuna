...
def print_startup_banner ():
    """Print the GhostX startup banner"""
    banner = [
        "GhostX Multipurpose Bot",
        "──────────────────────────────────────",
        "System: Operational",
        "Developer: bucu0368 (GhostX Development)",
        "Community: https://discord.gg/Zg2XkS5hq9",
        "──────────────────────────────────────"
    ]
    for line in banner:
...
def print_system_ready ():
    ...
    logger.success("SYSTEM", "GhostX is now online and ready to serve!")
