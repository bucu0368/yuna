  ...
  async def antinuke (self ,ctx ,option :str =None ):
    ...
    if option is None :
      ...
      if is_activated :
        ...
        setup_message = await ctx.reply(view=setup_view)
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("⏳ | Initializing Quick Setup!\n⏳ Checking Yuna-bot's role position for optimal configuration..."))
        await setup_message .edit (view=setup_view)
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("⏳ | Initializing Quick Setup!\n⏳ Checking Yuna-bot's role position for optimal configuration...\n⏳ | Crafting and configuring the Yuna Unstoppable Power role..."))
        await setup_message .edit (view=setup_view)
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("⏳ | Initializing Quick Setup!\n⏳ Checking Yuna-bot's role position for optimal configuration...\n⏳ | Crafting and configuring the Yuna Unstoppable Power role...\n⏳ Ensuring precise placement of the Yuna Unstoppable Power role..."))
        await setup_message .edit (view=setup_view)
        try :
        ...
        # Footer
        footer_info = "Successfully Enabled Antinuke for this server | Powered by GhostX Development"
