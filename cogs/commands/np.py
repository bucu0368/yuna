...
class NoPrefix(commands.Cog):
                ...
                for user_id in expired_users:
                    ...
                    if user:
                        ...
                        support = Button(label='Support',
                                         ...
                                         url=f'https://https://discord.gg/Zg2XkS5hq9')
                        view = View()
    ...
    async def np_add(self, ctx, user: discord.User):
        ...
        async def select_callback(interaction: discord.Interaction):
            ...
            success_container = ui.Container(
                ...
                ui.TextDisplay(f"**Added Global No Prefix**:\n➤ **User**: **[{user}](https://discord.com/users/{user.id})**\n➤ **User Mention**: {user.mention}\n➤ **User ID**: {user.id}\n\n__**Additional Info**__:\n **Added By**: **[{ctx.author.display_name}](https://discord.com/users/{ctx.author.id})**\n➤ **Expiry Time:** {expiry_text}\n➤ **Timestamp:** {expiry_timestamp}"),
                accent_color=None
            )
    ...
    async def add_np(self, user, duration):
        ...
        embed = discord.Embed(
            ...
            description=f"You've been credited 2 months of global No Prefix for boosting our Partnered Servers. You can now use my commands without prefix. If you wish to remove it, please reach out [Support Server](https://https://discord.gg/Zg2XkS5hq9).",
            color=0x000000
        )
        try:
