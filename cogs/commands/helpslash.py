...
class HelpLayout(ui.LayoutView):
    ...
    def setup_main_content(self):
        ...
        new_content = (
            f"🦋 Hey [{self.ctx.author.display_name}]({self.ctx.author.avatar.url if self.ctx.author.avatar else 'https://discord.com'})!\n"
            f"I'm **Yuna**, your friendly companion.\n\n"
            f"   ➤ Prefix for this server: **{self.server_prefix}**\n"
            f"   ➤ Pick from the menu to continue!"
        )
